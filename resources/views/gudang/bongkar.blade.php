...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                <form id="form" method="POST" action="/gudang/perekamanbongkar?filter=1&export=1">
                    @csrf
                    <div class="row">
    ...
    $(function(){
        ...
        var grid = $("#grid").DataTable({responsive: false,
            ...
            rowCallback: function(row, data)
            {
                ...
                $('td:eq(0)', row).html('<a title="Edit" href="/gudang/userbongkar/' + data.ID + '"><i class="fa fa-edit"></i></a>');
            },
            columnDefs: [
        ...
        $("#preview").on("click", function(){
            $.ajax({
            method: "POST",
            url: "/gudang/perekamanbongkar?filter=1",
            data: $("#form").serialize(),
