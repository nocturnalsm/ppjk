    ...
    <div class="card col-md-12 p-0">
        ...
        <div class="card-body">
            ...
            <div class="form-row px-2">
                ...
                <div class="col-md-2">
                    <input {{ $readonly }} type="text" maxlength="24" class="form-control form-control-sm" name="nosptnp" id="nosptnp" value="{{ $header->NO_SPTNP }}">
                </div>
                <label class="col-md-1 col-form-label form-control-sm text-right">Tgl SPTNP</label>
                <div class="col-md-1">
                    <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tglsptnp" value="{{ $header->TGL_SPTNP }}" id="tglsptnp">
                </div>
            </div>
            <div class="form-row px-2">
              ...
              <div class="col-md-1">
                  <input {{ $readonly }} type="text" maxlength="6" class="form-control form-control-sm" name="noaju" value="{{ $header->NOAJU }}" id="noaju">
              </div>
            </div>
            <div class="row px-2">
                        ...
                        <div class="card col-md-12 p-0  mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="form-row px-2 pb-0">
                                    ...
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="bmtb" value="{{ $header->BMTB }}" id="bmtb">
                                    </div>
                                    <label class="col-md-2 col-form-label form-control-sm">BM KITE</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="bmkite" value="{{ $header->BMKITE }}" id="bmkite">
                                    </div>
                                </div>
                                <div class="form-row px-2 pb-0">
                                    <label class="col-md-2 col-form-label form-control-sm">BMT</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="bmttb" value="{{ $header->BMTTB }}" id="bmttb">
                                    </div>
                                    <label class="col-md-2 col-form-label form-control-sm">PPN</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="ppntb" value="{{ $header->PPNTB }}" id="ppntb">
                                    </div>
                                </div>
                                <div class="form-row px-2 pb-0">
                                    <label class="col-md-2 col-form-label form-control-sm">PPNBM</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="ppnbm" value="{{ $header->PPNBM }}" id="ppnbm">
                                    </div>
                                    <label class="col-md-2 col-form-label form-control-sm">PPH Pasal 22</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="pphtb" value="{{ $header->PPHTB }}" id="pphtb">
                                    </div>
                                </div>
                                <div class="form-row px-2 pb-0">
                                    <label class="col-md-2 col-form-label form-control-sm">Denda</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="number form-control form-control-sm" name="dendatb" value="{{ $header->DENDA_TB }}" id="dendatb">
                                    </div>
                                ...
                                <div class="form-row px-2 pb-0">
                                    ...
                                    <div class="col-md-3">
                                        <select {{ $readonly == 'readonly' ? 'disabled' : '' }} class="form-control form-control-sm" id="jenissptnp" name="jenissptnp" value="{{ $header->JENIS_SPTNP }}">
                        ...
                        <div class="card col-md-12 p-0 mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="form-row px-2">
                                    ...
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tgllunas" value="{{ $header->TGL_LUNAS }}" id="tgllunas">
                                    </div>
                                    <label class="col-md-2 col-form-label form-control-sm">Tgl BRT</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tglbrt" value="{{ $header->TGL_BRT }}" id="tglbrt">
                                    </div>
                                </div>
                                <div class="form-row px-2 pb-0">
                                    <label class="col-md-2 col-form-label form-control-sm">Hasil BRT</label>
                                    <div class="col-md-3">
                                        <select {{ $readonly == 'readonly' ? 'disabled' : '' }} class="form-control form-control-sm" id="hslbrt" name="hslbrt" value="{{ $header->HSL_BRT }}">
                                    ...
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" maxlength="6" class="form-control form-control-sm" name="nokepbrt" value="{{ $header->NO_KEPBRT }}" id="nokepbrt">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">Tgl Kep Berat</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tglkepbrt" value="{{ $header->TGL_KEPBRT }}" id="tglkepbrt">
                                    </div>
                                    <label class="col-md-2 col-form-label form-control-sm">Tgl Jth Tempo Bdg</label>
                                    <div class="col-md-3">
                                        <input {{ $readonly }} autocomplete="off" readonly type="text" class="datepicker disabled form-control form-control-sm" name="tgljthtmpbdg" value="{{ $header->TGL_JTHTEMPO_BDG }}" id="tgljthtmpbdg">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card col-md-12 p-0 mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="form-row px-2">
                                    ...
                                    <div class="col-md-2">
                                        <input {{ $readonly }} type="text" maxlength="10" class="form-control form-control-sm" name="nobdg" value="{{ $header->NO_BDG }}" id="nobdg">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm">Tgl Sengk</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tglbdg" value="{{ $header->TGL_BDG }}" id="tglbdg">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm">Majelis</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} type="text" maxlength="3" class="form-control form-control-sm" name="majelis" value="{{ $header->MAJELIS }}" id="majelis">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">SDG.01</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg01" value="{{ $header->SDG01 }}" id="sdg01">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm">SDG.02</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg02" value="{{ $header->SDG02 }}" id="sdg02">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">SDG.03</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg03" value="{{ $header->SDG03 }}" id="sdg03">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm">SDG.04</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg04" value="{{ $header->SDG04 }}" id="sdg04">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">SDG.05</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg05" value="{{ $header->SDG05 }}" id="sdg05">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm">SDG.06</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg06" value="{{ $header->SDG06 }}" id="sdg06">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">SDG.07</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="sdg07" value="{{ $header->SDG05 }}" id="sdg05">
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">Hasil Bdg</label>
                                    <div class="col-md-5">
                                        <textarea {{ $readonly }} rows="3" class="form-control form-control-sm" name="hasilbdg" id="hasilbdg">{{ $header->HASIL_BDG }}</textarea>
                                    </div>
                                </div>
                                <div class="form-row px-2">
                                    <label class="col-md-2 col-form-label form-control-sm">No Kep Bdg</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} type="text" maxlength="6" class="form-control form-control-sm" name="nokepbdg" value="{{ $header->NO_KEP_BDG }}" id="nokepbdg">
                                    </div>
                                    <label class="col-md-1 col-form-label form-control-sm pr-0">Tgl Kep Bdg</label>
                                    <div class="col-md-2">
                                        <input {{ $readonly }} autocomplete="off" type="text" class="datepicker{{ $readonly == 'readonly' ? '-readonly' : '' }} form-control form-control-sm" name="tglkepbdg" value="{{ $header->TGL_KEP_BDG }}" id="tglkepbdg">
                                    </div>
                                </div>
                            </div>
                        </div>
