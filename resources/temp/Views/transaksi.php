    ...
    <div class="card col-md-12 p-0">
        ...
        <div class="card-body">
            ...
            <div class="row mt-0 mb-2">
                ...
                <!--
                <label class="form-control-sm">Gudang</label>
                <div class="col-md-1 px-1">
                    <select class="form-control form-control-sm" id="gudang" name="gudang" value="{{ header.GUDANG_ID }}">
                        <option value=""></option>
                        {% for gdg in gudang %}
                        <option {% if header.GUDANG_ID == gdg.GUDANG_ID %}selected{% endif %} value="{{ gdg.GUDANG_ID }}">{{ gdg.KODE }}</option>
                        {% endfor %}
                    </select>
                    <p class="error gudang">Kode Gudang harus dipilih</p>
                </div>
                <label class="form-control-sm">Tanggal Rekam</label>
                <div class="col-md-1 px-1">
                    <input autocomplete="off" type="text" class="datepicker form-control form-control-sm" name="tglrekam" id="tglrekam" value="{{ header.TGL_REKAM }}">            
                </div>-->
            </div>
            <div class="row px-2">
                        ...
                        <div class="card col-md-12 p-0 mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="form-row px-2 pb-0">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="number form-control form-control-sm" name="total" id="total" value="{{ header.TOTAL_SPTNP }}">                            
                                    </div>           
...
$("#btnsimpan").on("click", function(){   
        ...
        $.ajax({
            url: "/transaksi/crud",
            data: {header: $("#transaksi").serialize(), kontainer: detailkontainer, detail: detail},
            type: "POST",
