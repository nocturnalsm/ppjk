...
<div class="card">
    <div class="card-header">
        Perekaman Pembayaran
    </div>
    <div class="card-body">
        <div class="row">            
            <div class="col-md-10">
                <form id="form" method="POST" action="/transaksi/perekamanbayar?filter=1&export=1">
                    <div class="row">
...
{target: 1, data: "IMPORTIR"}, {target: 2, data: "CUSTOMER", {% if userlevel == 6 %}visible:  false{% endif %}},  
...
var grid = $("#grid").DataTable({responsive: false,
    ...
    {                
        ...
        $('td:eq(8)', row).html(parseFloat(data.CIF).formatMoney(2,"",",","."));        
        $('td:eq(9)', row).html(parseFloat(data.BAYAR).formatMoney(2,"",",","."));
        $('td:eq(10)', row).html((parseFloat(data.CIF) - parseFloat(data.BAYAR)).formatMoney(2,"",",","."));
    }
}); 
