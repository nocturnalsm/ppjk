                    ...
                    <div class="form-row mb-1">                        
                        ...
                        <div class="col-md-9 pt-2">
                            <select class="form-control form-control-sm" id="jeniskemasan" name="jeniskemasan">
                                ...
                                <option value="{{ jenis.JENISKEMASAN_ID }}">{{ jenis.URAIAN }}</option>
                                {% endfor %}
                            </select>
                        </div>
                    </div>
...
<div class="row">
    <div class="card col-md-12 p-0">
        ...
        <div class="card-body">
            ...
            <input id="deletedetail" name="deletedetail" type="hidden" value="">
            <div class="row px-2">
                        ...
                        <div class="card col-md-12 p-0 mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="form-row px-2 pb-0">
                                    ...
                                    <label class="col-md-1 col-form-label form-control-sm text-right">Pengirim</label>
                                    <div class="col-md-4">                                       
                                ...
                                <div class="form-row px-2">                        
                                    ...
                                    <label class="col-form-label col-md-1 form-control-sm" for="nilai">Tgl Konversi</label>
                                    <div class="col-md-2">
                                        <input type="text" class="datepicker form-control form-control-sm" name="tglkonversi" value="{{ header.TGL_KONVERSI }}" id="tglkonversi">                           
                                    </div>
                                </div>
                            </div>
                        </div>
