...
<form id="form">                    
    ...
    <div class="mb-1">                        
        <label for="input-satuan">Nama Satuan</label>
        <input type="text" id="input-satuan" name="input-satuan" class="form-control">                        
    </div>
</form>
{% endblock %}
{% block scripts %}
    ...
    },
    {
      ...
      action: function (e, dt){
        ...
        $("#modal .btn-ok").html("Ya").on("click", function(){
            ...
            $.ajax({
                url: "/master/crud",
                data: {action: "satuan", input: $.param({"input-action": "delete", "id": row[0].id})},
                type: "POST",
...
$("#saveform").on("click", function(){
    ...
    $.ajax({
        url: "/master/crud",
        data: {action: "satuan", input: $("#form").serialize()},
        type: "POST",
        success: function(msg) {
            if (typeof msg.error != 'undefined'){
                $("#modal .modal-body").html(msg.error);
