            ...
            <div class="modal-body mx-3">                    
                <form id="form" act="">            
                    ...
                    <div class="form-row mb-1">                        
                        <label class="col-form-label col-md-3" for="penerima">Penerima</label>
                        <div class="col-md-9">
                        <select class="form-control form-control-sm" id="penerima" name="penerima">
                            {% for terima in datapenerima %}
                            <option value="{{ terima.PENERIMA_ID }}">{{ terima.URAIAN }}</option>
                            {% endfor %}
                        </select>
                        </div>
                    </div>
...
$("a#deletetransaksi").on("click", function(){
    ...
    $("#modal .btn-ok").html("Ya").on("click", function(){
        $.ajax({
            url: "/transaksi/crud",
            data: {type: "bayar", delete: "{{ header.ID}}"},
            type: "POST",
            success: function(msg){
