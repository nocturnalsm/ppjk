        ...
        <div class="card-header font-weight-bold">
            <div class="row">
                ...
                <div class="col-md-8 py-0 pr-4 text-right">
                    ...
                    {% if (header is defined) and (header.ID is not null) %}
                                ...
                                <div class="form-row px-2 pb-0">                    
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control form-control-sm" id="pembeli" name="pembeli">
                                            <option {%if header.PEMBELI == '' or header.PEMBELI is null %}selected{% endif %} value=""></option>
                                            {% for pembeli in datapembeli %}
...
var pengeluaran = "{{ pengeluaran|escape('js') }}";
...
$("#btnsimpan").on("click", function(){   
    ...
    $.ajax({
        url: "/transaksi/crud",
        data: {type: "deliveryorder", header: $("#transaksi").serialize(), detail: detail, pengeluaran: pengeluaran },
        type: "POST",
        cache: false,
...
{% if (header.ID is defined) and (header.ID is not null) %}
$("a#deletetransaksi").on("click", function(){
    ...
    $("#modal .btn-ok").html("Ya").on("click", function(){
        ...
        $.ajax({
            url: "/transaksi/crud",
            data: {type: "deliveryorder", delete: "{{ header.ID}}"},
            type: "POST",
            success: function(msg){
